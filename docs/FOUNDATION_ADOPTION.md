...
- stable repository identity before privileged effects;
- `CURRENT_WORK` as operational handoff;
- `ROADMAP` as strategic direction;
- `AGENTS` as execution/routing protocol;
- broad cognition with narrow effects;
- access is not authority;
- development and operations are distinct;
- external dispatch is not verification PASS;
- cheapest qualified compute backend with no assurance regression;
